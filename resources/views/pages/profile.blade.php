			...
			<div class="portflio-link">
				...
				<ul><li>@if($liked)
				 ...
				 <i class="fa fa-heart-o"></i>
				  ...
				  @else
						 <a href="/profile/{{$user->username}}/like"> <i class="fa fa-heart"></i>  {{$user->likes}}</a>
						@endif
</li><li>
						@if($user->facebook)
					...
					<div class="tabs-profile">
						<ul class="nav nav-tabs">
							...
							<li><a data-toggle="tab" href="#image3">image</a></li>
							<li><a data-toggle="tab" href="#video4">video</a></li>
						</ul>
						...
						<div class="tab-content">
							...
							<div id="video4" class="tab-pane fade">
								@if($owner)
